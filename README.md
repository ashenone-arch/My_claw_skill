...
| Skill | 版本 | 核心功能 |
|-------|------|---------|
| [daily-seller-hotspot](daily-seller-hotspot/) | v1.2 | 每日扫描卖方抱团方向，识别机构注意力焦点 |
...
| Skill | 版本 | 核心功能 |
|-------|------|---------|
| [fact-hub](fact-hub/) | v2.1 | 事实、观点、冲突三层知识库，追踪认知迭代 |
| [cross-talk-synthesis](cross-talk-synthesis/) | v2.7 | 多篇对谈交叉汇总，按话题轴心组织观点碰撞 |

### 分析/决策

| Skill | 版本 | 核心功能 |
|-------|------|---------|
| [equity-deep-research](equity-deep-research/) | v2.12 | A股上市公司9段深度投研框架 |
| [howard-marks-framework](howard-marks-framework/) | v2.2 | 霍华德·马克斯投资框架评估标的 |
...
| Skill | 版本 | 核心功能 |
|-------|------|---------|
| [skill-sync](skill-sync/) | v1.11 | Skill本地与GitHub双向同步 |
| [fact-hub-sync](fact-hub-sync/) | v2.1 | Fact Hub知识库GitHub同步备份 |
