...
- **v2.10**：写作前综合检查新增第 7 条「Fact Hub 交叉引用」——写报告前检查 Fact Hub 中相关主题的 opinions.md，识别可应用的跨赛道分析框架（如 [T-AI-001] 算力→资金双层约束、[T-AI-003] 囚徒困境军备竞赛等），避免每次重复发明。若无 Fact Hub 或主题为空则自动跳过。
